...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("/Users/zhanglujie/Documents/dubbo/guns/guns-film/src/main/java");//这里写你自己的java目录
        gc.setFileOverride(true);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("zhanglujie");
        ...
        strategy.setInclude(new String[]{"mooc_banner_t","mooc_cat_dict_t","mooc_actor_t","mooc_film_info_t","mooc_film_t","mooc_source_dict_t","mooc_year_dict_t"});
